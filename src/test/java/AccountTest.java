...
public class AccountTest {
    ...
    @Test
    @DisplayName("Возвращается true, если все проверки пройдены и имя 3 символа")
    ...
    @Test
    @DisplayName("Возвращается true, если все проверки пройдены и имя 19 символов")
    ...
    @Test
    @DisplayName("Возвращается false, если в строке ничего нет")
    ...
    @Test
    @DisplayName("Возвращается false, если есть пробел в начале")
    ...
    @Test
    @DisplayName("Возвращается false, если есть пробел в конце")
    ...
    @Test
    @DisplayName("Возвращается false, если есть пробел в начале и конце")
    ...
    @Test
    @DisplayName("Возвращается false, если нет пробела внутри")
    ...
    @Test
    @DisplayName("Возвращается false, если внутри больше одного пробела")
    ...
    @Test
    @DisplayName("Возвращается false, если имя короче 3 символов")
    ...
    @Test
    @DisplayName("Возвращается false, если имя больше 19 символов")
